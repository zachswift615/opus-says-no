...
The final batch of detailed planning must include this manual verification task. Instruct the batch writer agent to produce it.
...
git commit -m "docs: add {feature-name} detailed implementation plan"
```
